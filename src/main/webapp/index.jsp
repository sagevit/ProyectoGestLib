...
<div class="container-fluid">
    <div class="row mt-5">
        ...
        <div class="col">
            <div class="container bg-light border rounded-3 shadow p-2 text-center py-5">
                <h1 class="display-6 fw-bold mt-5">GestLib</h1>
                <p class="fs-5 mb-5">Gestión integrada de Bibliotecas</p>
            </div>
        </div>
    </div>
</div>
